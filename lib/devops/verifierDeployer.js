...
var VERIFIER_FILE = path_1.default.join(process.cwd(), './.verifier.json');
...
var Verifier = /** @class */ (function (_super) {
    ...
    function Verifier() {
        ...
        _this.verifier = [];
        _this.verifier = require(VERIFIER_FILE);
    ...
    Verifier.prototype.baseUrl = function (chainId) {
        switch (chainId) {
            case 1:
    ...
    Verifier.prototype.isVerified = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var chainId, url, isVerified;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, hre.network.config.chainId];
                    case 1:
                        chainId = _a.sent();
                        url = "".concat(this.baseUrl(chainId), "/api?module=contract&action=getabi&address=").concat(address, "&apikey=").concat(this.apiKey);

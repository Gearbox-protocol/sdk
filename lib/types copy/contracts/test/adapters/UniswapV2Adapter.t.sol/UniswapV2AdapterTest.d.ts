...
export interface UniswapV2AdapterTestInterface extends utils.Interface {
    functions: {
        ...
        "test_AUV2_01_constructor_reverts_for_zero_addresses()": FunctionFragment;
        "test_AUV2_02_constructor_sets_correct_values()": FunctionFragment;
        "test_AUV2_03_swap_reverts_if_uses_has_no_account()": FunctionFragment;
        "test_AUV2_04_swapExactTokensForTokens_works_for_user_as_expected()": FunctionFragment;
        "test_AUV2_05_swapTokensForExactTokens_works_for_user_as_expected()": FunctionFragment;
        "test_AUV2_06_swapAllTokensForTokens_works_for_user_as_expected()": FunctionFragment;
        "test_AUV2_07_multicall_swapExactTokensForTokens_works_for_user_as_expected()": FunctionFragment;
        "test_AUV2_09_multicall_swapTokensForExactTokens_works_for_user_as_expected()": FunctionFragment;
        "test_AUV2_12_adapter_quote_same_as_router(uint256,uint256,uint256)": FunctionFragment;
        "test_AUV2_13_adapter_getAmountOut_same_as_router(uint256,uint256,uint256)": FunctionFragment;
        "test_AUV2_14_adapter_getAmountIn_same_as_router(uint256,uint256,uint256)": FunctionFragment;
        "test_AUV2_15_adapter_getAmountsOut_same_as_router(uint256)": FunctionFragment;
        "test_AUV2_16_adapter_getAmountsIn_same_as_router(uint256)": FunctionFragment;
        "underlying()": FunctionFragment;
        "uniswapMock()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "adapter" | "cft" | "creditConfigurator" | "creditFacade" | "creditManager" | "deadline" | "failed" | "setUp" | "test_AUV2_01_constructor_reverts_for_zero_addresses" | "test_AUV2_02_constructor_sets_correct_values" | "test_AUV2_03_swap_reverts_if_uses_has_no_account" | "test_AUV2_04_swapExactTokensForTokens_works_for_user_as_expected" | "test_AUV2_05_swapTokensForExactTokens_works_for_user_as_expected" | "test_AUV2_06_swapAllTokensForTokens_works_for_user_as_expected" | "test_AUV2_07_multicall_swapExactTokensForTokens_works_for_user_as_expected" | "test_AUV2_09_multicall_swapTokensForExactTokens_works_for_user_as_expected" | "test_AUV2_12_adapter_quote_same_as_router" | "test_AUV2_13_adapter_getAmountOut_same_as_router" | "test_AUV2_14_adapter_getAmountIn_same_as_router" | "test_AUV2_15_adapter_getAmountsOut_same_as_router" | "test_AUV2_16_adapter_getAmountsIn_same_as_router" | "underlying" | "uniswapMock"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_AUV2_01_constructor_reverts_for_zero_addresses", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_02_constructor_sets_correct_values", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_03_swap_reverts_if_uses_has_no_account", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_04_swapExactTokensForTokens_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_05_swapTokensForExactTokens_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_06_swapAllTokensForTokens_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_07_multicall_swapExactTokensForTokens_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_09_multicall_swapTokensForExactTokens_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_12_adapter_quote_same_as_router", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_AUV2_13_adapter_getAmountOut_same_as_router", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_AUV2_14_adapter_getAmountIn_same_as_router", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_AUV2_15_adapter_getAmountsOut_same_as_router", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_AUV2_16_adapter_getAmountsIn_same_as_router", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "test_AUV2_01_constructor_reverts_for_zero_addresses", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_02_constructor_sets_correct_values", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_03_swap_reverts_if_uses_has_no_account", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_04_swapExactTokensForTokens_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_05_swapTokensForExactTokens_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_06_swapAllTokensForTokens_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_07_multicall_swapExactTokensForTokens_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_09_multicall_swapTokensForExactTokens_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_12_adapter_quote_same_as_router", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_13_adapter_getAmountOut_same_as_router", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_14_adapter_getAmountIn_same_as_router", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_15_adapter_getAmountsOut_same_as_router", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_16_adapter_getAmountsIn_same_as_router", data: BytesLike): Result;
...
export interface UniswapV2AdapterTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: UniswapV2AdapterTestInterface;
    ...
    functions: {
        ...
        test_AUV2_01_constructor_reverts_for_zero_addresses(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_02_constructor_sets_correct_values(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_03_swap_reverts_if_uses_has_no_account(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_04_swapExactTokensForTokens_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_05_swapTokensForExactTokens_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_06_swapAllTokensForTokens_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_07_multicall_swapExactTokensForTokens_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_09_multicall_swapTokensForExactTokens_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_12_adapter_quote_same_as_router(amountA: BigNumberish, reserveA: BigNumberish, reserveB: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_13_adapter_getAmountOut_same_as_router(amountIn: BigNumberish, reserveIn: BigNumberish, reserveOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_14_adapter_getAmountIn_same_as_router(amountOut: BigNumberish, reserveIn: BigNumberish, reserveOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_15_adapter_getAmountsOut_same_as_router(amountIn: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_16_adapter_getAmountsIn_same_as_router(amountOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_AUV2_01_constructor_reverts_for_zero_addresses(overrides?: CallOverrides): Promise<void>;
        test_AUV2_02_constructor_sets_correct_values(overrides?: CallOverrides): Promise<void>;
        test_AUV2_03_swap_reverts_if_uses_has_no_account(overrides?: CallOverrides): Promise<void>;
        test_AUV2_04_swapExactTokensForTokens_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AUV2_05_swapTokensForExactTokens_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AUV2_06_swapAllTokensForTokens_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AUV2_07_multicall_swapExactTokensForTokens_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AUV2_09_multicall_swapTokensForExactTokens_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AUV2_12_adapter_quote_same_as_router(amountA: BigNumberish, reserveA: BigNumberish, reserveB: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_AUV2_13_adapter_getAmountOut_same_as_router(amountIn: BigNumberish, reserveIn: BigNumberish, reserveOut: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_AUV2_14_adapter_getAmountIn_same_as_router(amountOut: BigNumberish, reserveIn: BigNumberish, reserveOut: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_AUV2_15_adapter_getAmountsOut_same_as_router(amountIn: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_AUV2_16_adapter_getAmountsIn_same_as_router(amountOut: BigNumberish, overrides?: CallOverrides): Promise<void>;
        underlying(overrides?: CallOverrides): Promise<string>;
        uniswapMock(overrides?: CallOverrides): Promise<string>;
    };
    filters: {

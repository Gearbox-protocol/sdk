...
export interface ConvexV1AdapterClaimZapTestInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "test_ACVX1_Z_01_claimRewards_works_correctly", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACVX1_Z_02_claimRewards_supports_claiming_from_extra_pools", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACVX1_Z_03_claimRewards_ignores_options", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACVX1_Z_04_multicall_claimRewards_works_correctly", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACVX1_Z_05_multicall_claimRewards_ignores_options", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_ACVX1_Z_01_claimRewards_works_correctly", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACVX1_Z_02_claimRewards_supports_claiming_from_extra_pools", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACVX1_Z_03_claimRewards_ignores_options", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACVX1_Z_04_multicall_claimRewards_works_correctly", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACVX1_Z_05_multicall_claimRewards_ignores_options", data: BytesLike): Result;
...
export interface ConvexV1AdapterClaimZapTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ConvexV1AdapterClaimZapTestInterface;
    ...
    functions: {
        ...
        test_ACVX1_Z_01_claimRewards_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACVX1_Z_02_claimRewards_supports_claiming_from_extra_pools(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACVX1_Z_03_claimRewards_ignores_options(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACVX1_Z_04_multicall_claimRewards_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACVX1_Z_05_multicall_claimRewards_ignores_options(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_ACVX1_Z_01_claimRewards_works_correctly(overrides?: CallOverrides): Promise<void>;
        test_ACVX1_Z_02_claimRewards_supports_claiming_from_extra_pools(overrides?: CallOverrides): Promise<void>;
        test_ACVX1_Z_03_claimRewards_ignores_options(overrides?: CallOverrides): Promise<void>;
        test_ACVX1_Z_04_multicall_claimRewards_works_correctly(overrides?: CallOverrides): Promise<void>;
        test_ACVX1_Z_05_multicall_claimRewards_ignores_options(overrides?: CallOverrides): Promise<void>;
        underlying(overrides?: CallOverrides): Promise<string>;
    };
    filters: {

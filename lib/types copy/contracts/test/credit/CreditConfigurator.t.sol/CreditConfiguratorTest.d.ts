...
export interface CreditConfiguratorTestInterface extends utils.Interface {
    functions: {
        ...
        "test_CC_30_upgradeCreditFacade_upgrades_creditFacade_and_doesnt_change_priceOracle(bool,bool)": FunctionFragment;
        "test_CC_31_upgradeCreditConfigurator_upgrades_creditConfigurator()": FunctionFragment;
        "test_CC_32_setIncreaseDebtForbidden_sets_IncreaseDebtForbidden(bool,bool)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_CC_30_upgradeCreditFacade_upgrades_creditFacade_and_doesnt_change_priceOracle", values: [boolean, boolean]): string;
    ...
    encodeFunctionData(functionFragment: "test_CC_32_setIncreaseDebtForbidden_sets_IncreaseDebtForbidden", values: [boolean, boolean]): string;
...
export interface CreditConfiguratorTest extends BaseContract {
    ...
    functions: {
        ...
        test_CC_30_upgradeCreditFacade_upgrades_creditFacade_and_doesnt_change_priceOracle(isIDF: boolean, migrateSettings: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_CC_31_upgradeCreditConfigurator_upgrades_creditConfigurator(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_CC_32_setIncreaseDebtForbidden_sets_IncreaseDebtForbidden(isIDF: boolean, initialIDF: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_CC_30_upgradeCreditFacade_upgrades_creditFacade_and_doesnt_change_priceOracle(isIDF: boolean, migrateSettings: boolean, overrides?: CallOverrides): Promise<void>;
        test_CC_31_upgradeCreditConfigurator_upgrades_creditConfigurator(overrides?: CallOverrides): Promise<void>;
        test_CC_32_setIncreaseDebtForbidden_sets_IncreaseDebtForbidden(isIDF: boolean, initialIDF: boolean, overrides?: CallOverrides): Promise<void>;

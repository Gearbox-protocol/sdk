...
export interface CreditFacadeTestInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "test_FA_04C_openCreditAccount_mints_token_in_whitelisted_mode", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_FA_04C_openCreditAccount_mints_token_in_whitelisted_mode", data: BytesLike): Result;
...
export interface CreditFacadeTest extends BaseContract {
    ...
    functions: {
        ...
        test_FA_04C_openCreditAccount_mints_token_in_whitelisted_mode(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_FA_04C_openCreditAccount_mints_token_in_whitelisted_mode(overrides?: CallOverrides): Promise<void>;

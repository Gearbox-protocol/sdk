...
export interface TokensTestSuiteInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "allowance" | "approve(uint8,address,address,uint256)" | "approve(uint8,address,address)" | "approve(address,address,address)" | "balanceOf" | "burn" | "failed" | "getPriceFeeds" | "priceFeeds" | "priceFeedsMap" | "prices" | "symbols" | "tokenIndexes" | "tokenToType" | "tokens" | "topUpWETH" | "transfer(uint8,address,uint256)" | "transfer(address,address,uint256)" | "wethToken"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "transfer(uint8,address,uint256)", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "transfer(address,address,uint256)", values: [string, string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "transfer(uint8,address,uint256)", data: BytesLike): Result;
...
export interface TokensTestSuite extends BaseContract {
    ...
    functions: {
        ...
        "transfer(uint8,address,uint256)"(t: BigNumberish, to: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "transfer(address,address,uint256)"(token: string, to: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "transfer(uint8,address,uint256)"(t: BigNumberish, to: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        "transfer(address,address,uint256)"(token: string, to: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        wethToken(overrides?: CallOverrides): Promise<string>;
    };
    filters: {

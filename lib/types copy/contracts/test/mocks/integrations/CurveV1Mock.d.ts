...
export interface CurveV1MockInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "balances" | "coins" | "exchange" | "exchange_underlying" | "get_dy" | "get_dy_underlying" | "get_virtual_price" | "lp_token" | "mintLP" | "remove_liquidity_one_coin" | "setRate" | "setRateUnderlying" | "set_virtual_price" | "token" | "underlying_coins" | "virtualPrice"): FunctionFragment;

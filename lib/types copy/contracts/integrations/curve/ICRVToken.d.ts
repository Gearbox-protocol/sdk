...
export interface ICRVTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "burnFrom" | "mint" | "set_minter" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface ICRVToken extends BaseContract {
    ...
    functions: {
        ...
        burnFrom(to: string, value: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        mint(to: string, value: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        set_minter(minter: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        balanceOf(account: string, overrides?: CallOverrides): Promise<BigNumber>;
        burnFrom(to: string, value: BigNumberish, overrides?: CallOverrides): Promise<boolean>;

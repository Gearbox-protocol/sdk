...
export declare type PoolOptsStruct = {
...
export declare type PoolOptsStructOutput = [
    string,
    string,
    BigNumber,
    BigNumber,
...
export interface PoolFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addressProvider" | "configure" | "destoy" | "getRootBack" | "owner" | "pool" | "renounceOwnership" | "root" | "transferOwnership" | "withdrawFee"): FunctionFragment;

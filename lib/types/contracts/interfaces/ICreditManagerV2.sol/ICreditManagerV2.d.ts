...
export interface ICreditManagerV2Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "adapterToContract" | "addCollateral" | "addToken" | "approveCreditAccount" | "calcClosePayments" | "calcCreditAccountAccruedInterest" | "changeContractAllowance" | "checkAndEnableToken" | "closeCreditAccount" | "collateralTokens" | "collateralTokensByMask" | "collateralTokensCount" | "contractToAdapter" | "creditAccounts" | "creditConfigurator" | "creditFacade" | "enabledTokensMap" | "executeOrder" | "fastCollateralCheck" | "fees" | "forbiddenTokenMask" | "fullCollateralCheck" | "getCreditAccountOrRevert" | "liquidationThresholds" | "manageDebt" | "openCreditAccount" | "pool" | "poolService" | "priceOracle" | "setForbidMask" | "setLiquidationThreshold" | "tokenMasksMap" | "transferAccountOwnership" | "underlying" | "version" | "wethAddress"): FunctionFragment;
...
export interface ICreditManagerV2 extends BaseContract {
    ...
    functions: {
        ...
        closeCreditAccount(borrower: string, isLiquidated: boolean, totalValue: BigNumberish, caller: string, to: string, skipTokenMask: BigNumberish, convertWETH: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        fastCollateralCheck(creditAccount: string, tokenIn: string, tokenOut: string, balanceInBefore: BigNumberish, balanceOutBefore: BigNumberish, ltCheck: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        liquidationThresholds(arg0: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        closeCreditAccount(borrower: string, isLiquidated: boolean, totalValue: BigNumberish, caller: string, to: string, skipTokenMask: BigNumberish, convertWETH: boolean, overrides?: CallOverrides): Promise<BigNumber>;
        collateralTokens(id: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            number
        ] & {
        ...
        fastCollateralCheck(creditAccount: string, tokenIn: string, tokenOut: string, balanceInBefore: BigNumberish, balanceOutBefore: BigNumberish, ltCheck: boolean, overrides?: CallOverrides): Promise<void>;
        fees(overrides?: CallOverrides): Promise<[
            number,
            number,
            number

...
export interface IDataCompressor extends BaseContract {
    ...
    estimateGas: {
        ...
        hasOpenedCreditAccount(creditManager: string, borrower: string, overrides?: CallOverrides): Promise<BigNumber>;
        version(overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        hasOpenedCreditAccount(creditManager: string, borrower: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

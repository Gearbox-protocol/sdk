...
export interface IGearTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "delegate" | "delegateBySig" | "getCurrentVotes" | "getPriorVotes" | "permit" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;

...
export declare namespace IUniswapV3Adapter {
    type ExactAllInputParamsStruct = {
        path: BytesLike;
        deadline: BigNumberish;
        rateMinRAY: BigNumberish;
    };
    type ExactAllInputParamsStructOutput = [
        string,
        BigNumber,
        BigNumber
    ] & {
    ...
    type ExactAllInputSingleParamsStruct = {
        tokenIn: string;
        tokenOut: string;
        fee: BigNumberish;
        deadline: BigNumberish;
    ...
    type ExactAllInputSingleParamsStructOutput = [
        string,
        string,
        number,
        BigNumber,
...
export interface UniswapV3AdapterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_gearboxAdapterType" | "_gearboxAdapterVersion" | "creditFacade" | "creditManager" | "exactAllInput" | "exactAllInputSingle" | "exactInput" | "exactInputSingle" | "exactOutput" | "exactOutputSingle" | "targetContract"): FunctionFragment;
...
export interface UniswapV3Adapter extends BaseContract {
    ...
    functions: {
        ...
        exactAllInputSingle(params: IUniswapV3Adapter.ExactAllInputSingleParamsStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;

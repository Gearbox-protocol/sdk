...
export interface CurveV1StETHPoolGatewayInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "add_liquidity" | "balances(int128)" | "balances(uint256)" | "coins(int128)" | "coins(uint256)" | "exchange" | "exchange_underlying" | "get_dy" | "get_dy_underlying" | "get_virtual_price" | "lp_token" | "pool" | "remove_liquidity" | "remove_liquidity_imbalance" | "remove_liquidity_one_coin" | "token" | "token0" | "token1" | "underlying_coins(int128)" | "underlying_coins(uint256)"): FunctionFragment;
...
export interface CurveV1StETHPoolGateway extends BaseContract {
    ...
    functions: {
        ...
        get_dy_underlying(arg0: BigNumberish, arg1: BigNumberish, arg2: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        "underlying_coins(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    };
    add_liquidity(amounts: [BigNumberish, BigNumberish], min_mint_amount: BigNumberish, overrides?: Overrides & {
        from?: string | Promise<string>;
    }): Promise<ContractTransaction>;
    ...
    estimateGas: {
        ...
        "underlying_coins(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        add_liquidity(amounts: [BigNumberish, BigNumberish], min_mint_amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        ...
        get_dy_underlying(arg0: BigNumberish, arg1: BigNumberish, arg2: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "underlying_coins(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}

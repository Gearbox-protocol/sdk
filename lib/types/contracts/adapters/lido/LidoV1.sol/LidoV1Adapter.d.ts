...
export interface LidoV1AdapterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_acl" | "_gearboxAdapterType" | "_gearboxAdapterVersion" | "creditFacade" | "creditManager" | "limit" | "pause" | "paused" | "setLimit" | "stETH" | "submit" | "submitAll" | "targetContract" | "treasury" | "unpause" | "weth"): FunctionFragment;

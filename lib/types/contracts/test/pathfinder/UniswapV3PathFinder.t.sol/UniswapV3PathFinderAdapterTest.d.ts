...
export interface UniswapV3PathFinderAdapterTestInterface extends utils.Interface {
    functions: {
        ...
        "test_PUV3_02_getBestPairSwap_returns_correct_swapQuote(uint256,uint256,uint256,uint256)": FunctionFragment;
        "test_PUV3_03_getBestPairSwap_returns_empty_swapQuote_when_pair_not_found()": FunctionFragment;
        "underlying()": FunctionFragment;
        "uniswapMock()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "adapter" | "cft" | "creditConfigurator" | "creditFacade" | "creditManager" | "deadline" | "failed" | "pathfinder" | "setUp" | "test_PUV3_01_setGasUsage_correctly_sets_values" | "test_PUV3_02_getBestPairSwap_returns_correct_swapQuote" | "test_PUV3_03_getBestPairSwap_returns_empty_swapQuote_when_pair_not_found" | "underlying" | "uniswapMock"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_PUV3_02_getBestPairSwap_returns_correct_swapQuote", values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_PUV3_03_getBestPairSwap_returns_empty_swapQuote_when_pair_not_found", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_PUV3_02_getBestPairSwap_returns_correct_swapQuote", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_PUV3_03_getBestPairSwap_returns_empty_swapQuote_when_pair_not_found", data: BytesLike): Result;
...
export interface UniswapV3PathFinderAdapterTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: UniswapV3PathFinderAdapterTestInterface;
    ...
    functions: {
        ...
        test_PUV3_02_getBestPairSwap_returns_correct_swapQuote(gasUsage: BigNumberish, amountIn: BigNumberish, daiWethRate: BigNumberish, slippageFactor: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_PUV3_03_getBestPairSwap_returns_empty_swapQuote_when_pair_not_found(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_PUV3_02_getBestPairSwap_returns_correct_swapQuote(gasUsage: BigNumberish, amountIn: BigNumberish, daiWethRate: BigNumberish, slippageFactor: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_PUV3_03_getBestPairSwap_returns_empty_swapQuote_when_pair_not_found(overrides?: CallOverrides): Promise<void>;
        underlying(overrides?: CallOverrides): Promise<string>;
        uniswapMock(overrides?: CallOverrides): Promise<string>;
    };
    filters: {

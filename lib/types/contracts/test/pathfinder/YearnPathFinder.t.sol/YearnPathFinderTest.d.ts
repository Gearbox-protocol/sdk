...
export interface YearnPathFinderTestInterface extends utils.Interface {
    functions: {
        ...
        "test_YPF_01_filterYearnAdapters_finds_yearn_adapters_only()": FunctionFragment;
        "test_YPF_02_estimateWithdraw_coverts_withfdraw_correctly()": FunctionFragment;
        "test_YPF_03_withdrawAll_works_correctly()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "_setUpCurve" | "cft" | "creditConfigurator" | "creditFacade" | "creditManager" | "curveAdapter" | "curveLPPathFinder" | "curveMetaAdapter" | "curvePathFinder" | "curveV1MetaMock" | "curveV1Mock" | "failed" | "setUp" | "test_YPF_01_filterYearnAdapters_finds_yearn_adapters_only" | "test_YPF_02_estimateWithdraw_coverts_withfdraw_correctly" | "test_YPF_03_withdrawAll_works_correctly" | "tokenMasksMap" | "underlying" | "uniV2adapter" | "uniV2mock" | "uniV2pathFinder" | "uniV3adapter" | "uniV3mock" | "uniV3pathFinder" | "yearnAdapter" | "yearnMock" | "yearnPathFinder"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_YPF_01_filterYearnAdapters_finds_yearn_adapters_only", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_YPF_02_estimateWithdraw_coverts_withfdraw_correctly", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_YPF_03_withdrawAll_works_correctly", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_YPF_01_filterYearnAdapters_finds_yearn_adapters_only", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_YPF_02_estimateWithdraw_coverts_withfdraw_correctly", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_YPF_03_withdrawAll_works_correctly", data: BytesLike): Result;
...
export interface YearnPathFinderTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: YearnPathFinderTestInterface;
    ...
    functions: {
        ...
        test_YPF_01_filterYearnAdapters_finds_yearn_adapters_only(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_YPF_02_estimateWithdraw_coverts_withfdraw_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_YPF_03_withdrawAll_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_YPF_01_filterYearnAdapters_finds_yearn_adapters_only(overrides?: CallOverrides): Promise<void>;
        test_YPF_02_estimateWithdraw_coverts_withfdraw_correctly(overrides?: CallOverrides): Promise<void>;
        test_YPF_03_withdrawAll_works_correctly(overrides?: CallOverrides): Promise<void>;
        tokenMasksMap(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        underlying(overrides?: CallOverrides): Promise<string>;
        uniV2adapter(overrides?: CallOverrides): Promise<string>;
        uniV2mock(overrides?: CallOverrides): Promise<string>;

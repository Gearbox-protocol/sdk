...
export interface SwapPathFinderTestInterface extends utils.Interface {
    functions: {
        ...
        "test_NTP_01_constructor_correctly_sets_initial_values()": FunctionFragment;
        "test_NTP_02_getPathFinder_returns_correct_values()": FunctionFragment;
        "test_NTP_03_findAllSwaps_found_a_pair_if_only_one_is_depdloyed(bool)": FunctionFragment;
        "test_NTP_04_findAllSwaps_found_quotes_INPUT(uint256,uint16,bool,bool)": FunctionFragment;
        "test_NTP_05_findAllSwaps_found_quotes_OUTPUT(uint256,uint16,bool)": FunctionFragment;
        "test_NTP_06_findAllSwaps_found_connector_quotes_and_take_the_best_INPUT(uint256,uint16,bool,bool)": FunctionFragment;
        "test_NTP_07_findAllSwaps_found_connector_quotes_and_take_the_best_OUTPUT(uint256,uint16,bool)": FunctionFragment;
        "test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_0(uint256,uint16,bool,bool)": FunctionFragment;
        "test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_non_zero(uint256,uint16,bool,bool,uint8)": FunctionFragment;
        "test_NTP_09_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_0(uint256,uint16,bool,bool)": FunctionFragment;
        "test_NTP_10_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_non_zero(uint256,uint16,bool,uint8)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_NTP_01_constructor_correctly_sets_initial_values", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_NTP_02_getPathFinder_returns_correct_values", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_NTP_03_findAllSwaps_found_a_pair_if_only_one_is_depdloyed", values: [boolean]): string;
    encodeFunctionData(functionFragment: "test_NTP_04_findAllSwaps_found_quotes_INPUT", values: [BigNumberish, BigNumberish, boolean, boolean]): string;
    encodeFunctionData(functionFragment: "test_NTP_05_findAllSwaps_found_quotes_OUTPUT", values: [BigNumberish, BigNumberish, boolean]): string;
    encodeFunctionData(functionFragment: "test_NTP_06_findAllSwaps_found_connector_quotes_and_take_the_best_INPUT", values: [BigNumberish, BigNumberish, boolean, boolean]): string;
    encodeFunctionData(functionFragment: "test_NTP_07_findAllSwaps_found_connector_quotes_and_take_the_best_OUTPUT", values: [BigNumberish, BigNumberish, boolean]): string;
    encodeFunctionData(functionFragment: "test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_0", values: [BigNumberish, BigNumberish, boolean, boolean]): string;
    encodeFunctionData(functionFragment: "test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_non_zero", values: [BigNumberish, BigNumberish, boolean, boolean, BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_NTP_09_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_0", values: [BigNumberish, BigNumberish, boolean, boolean]): string;
    encodeFunctionData(functionFragment: "test_NTP_10_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_non_zero", values: [BigNumberish, BigNumberish, boolean, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "test_NTP_01_constructor_correctly_sets_initial_values", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_02_getPathFinder_returns_correct_values", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_03_findAllSwaps_found_a_pair_if_only_one_is_depdloyed", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_04_findAllSwaps_found_quotes_INPUT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_05_findAllSwaps_found_quotes_OUTPUT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_06_findAllSwaps_found_connector_quotes_and_take_the_best_INPUT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_07_findAllSwaps_found_connector_quotes_and_take_the_best_OUTPUT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_0", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_non_zero", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_09_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_0", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NTP_10_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_non_zero", data: BytesLike): Result;
...
export interface SwapPathFinderTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SwapPathFinderTestInterface;
    ...
    functions: {
        ...
        test_NTP_01_constructor_correctly_sets_initial_values(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_02_getPathFinder_returns_correct_values(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_03_findAllSwaps_found_a_pair_if_only_one_is_depdloyed(isAll: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_04_findAllSwaps_found_quotes_INPUT(amountIn: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_05_findAllSwaps_found_quotes_OUTPUT(amountOut: BigNumberish, slippage: BigNumberish, externalSlippage: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_06_findAllSwaps_found_connector_quotes_and_take_the_best_INPUT(amountIn: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_07_findAllSwaps_found_connector_quotes_and_take_the_best_OUTPUT(amountOut: BigNumberish, slippage: BigNumberish, externalSlippage: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_0(amountIn: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_non_zero(amountIn: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, whoWins: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_09_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_0(amountOut: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_NTP_10_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_non_zero(amountOut: BigNumberish, slippage: BigNumberish, externalSlippage: boolean, whoWins: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_NTP_01_constructor_correctly_sets_initial_values(overrides?: CallOverrides): Promise<void>;
        test_NTP_02_getPathFinder_returns_correct_values(overrides?: CallOverrides): Promise<void>;
        test_NTP_03_findAllSwaps_found_a_pair_if_only_one_is_depdloyed(isAll: boolean, overrides?: CallOverrides): Promise<void>;
        test_NTP_04_findAllSwaps_found_quotes_INPUT(amountIn: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, overrides?: CallOverrides): Promise<void>;
        test_NTP_05_findAllSwaps_found_quotes_OUTPUT(amountOut: BigNumberish, slippage: BigNumberish, externalSlippage: boolean, overrides?: CallOverrides): Promise<void>;
        test_NTP_06_findAllSwaps_found_connector_quotes_and_take_the_best_INPUT(amountIn: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, overrides?: CallOverrides): Promise<void>;
        test_NTP_07_findAllSwaps_found_connector_quotes_and_take_the_best_OUTPUT(amountOut: BigNumberish, slippage: BigNumberish, externalSlippage: boolean, overrides?: CallOverrides): Promise<void>;
        test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_0(amountIn: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, overrides?: CallOverrides): Promise<void>;
        test_NTP_08_getBestDirectPairSwap_found_the_best_swap_with_INPUT_GP_non_zero(amountIn: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, whoWins: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_NTP_09_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_0(amountOut: BigNumberish, slippage: BigNumberish, isAll: boolean, externalSlippage: boolean, overrides?: CallOverrides): Promise<void>;
        test_NTP_10_getBestDirectPairSwap_found_the_best_swap_with_OUTPUT_GP_non_zero(amountOut: BigNumberish, slippage: BigNumberish, externalSlippage: boolean, whoWins: BigNumberish, overrides?: CallOverrides): Promise<void>;
        tokenMasksMap(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        underlying(overrides?: CallOverrides): Promise<string>;
        uniV2adapter(overrides?: CallOverrides): Promise<string>;
        uniV2mock(overrides?: CallOverrides): Promise<string>;

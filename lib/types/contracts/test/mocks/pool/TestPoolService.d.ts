...
export interface TestPoolServiceInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getCumulativeIndex_RAY", values?: undefined): string;
    encodeFunctionData(functionFragment: "getDieselRate_RAY", values?: undefined): string;
    encodeFunctionData(functionFragment: "getExpectedLU", values?: undefined): string;
    encodeFunctionData(functionFragment: "getTimestampLU", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setExpectedLiquidity", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "updateBorrowRate", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getCumulativeIndex_RAY", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getDieselRate_RAY", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getExpectedLU", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getTimestampLU", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setExpectedLiquidity", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "updateBorrowRate", data: BytesLike): Result;
...
export interface TestPoolService extends BaseContract {
    ...
    functions: {
        ...
        setExpectedLiquidity(newExpectedLiquidity: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        updateBorrowRate(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setExpectedLiquidity(newExpectedLiquidity: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        getCumulativeIndex_RAY(overrides?: CallOverrides): Promise<PopulatedTransaction>;

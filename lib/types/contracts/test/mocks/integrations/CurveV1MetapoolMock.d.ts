...
export interface CurveV1MetapoolMockInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "balances(int128)" | "balances(uint256)" | "basePool" | "coins(int128)" | "coins(uint256)" | "exchange" | "exchange_underlying" | "get_dy" | "get_dy_underlying" | "get_virtual_price" | "lp_token" | "remove_liquidity_one_coin" | "setRate" | "setRateUnderlying" | "set_virtual_price" | "token" | "underlying_coins(int128)" | "underlying_coins(uint256)" | "virtualPrice"): FunctionFragment;

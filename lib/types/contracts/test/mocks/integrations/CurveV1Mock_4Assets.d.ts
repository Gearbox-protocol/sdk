...
export interface CurveV1Mock_4Assets extends BaseContract {
    ...
    functions: {
        ...
        calc_token_amount(arg0: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], arg1: boolean, overrides?: CallOverrides): Promise<[BigNumber]>;
        calc_withdraw_one_coin(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        get_twap_balances(_first_balances: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], arg1: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], arg2: BigNumberish, overrides?: CallOverrides): Promise<[[BigNumber, BigNumber, BigNumber, BigNumber]]>;
    ...
    estimateGas: {
        ...
        get_twap_balances(_first_balances: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], arg1: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], arg2: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        get_virtual_price(overrides?: CallOverrides): Promise<BigNumber>;
        initial_A(overrides?: CallOverrides): Promise<BigNumber>;
        initial_A_time(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        calc_token_amount(arg0: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], arg1: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calc_withdraw_one_coin(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        get_twap_balances(_first_balances: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], arg1: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], arg2: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

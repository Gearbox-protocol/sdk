...
export interface ERC20MockInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "burn" | "burnFrom" | "decimals" | "decreaseAllowance" | "increaseAllowance" | "mint" | "minter" | "name" | "owner" | "renounceOwnership" | "set_minter" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership"): FunctionFragment;
...
export interface ERC20Mock extends BaseContract {
    ...
    functions: {
        ...
        burn(to: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        burnFrom(to: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        set_minter(_minter: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        balanceOf(account: string, overrides?: CallOverrides): Promise<BigNumber>;
        burn(to: string, amount: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        burnFrom(to: string, amount: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        decimals(overrides?: CallOverrides): Promise<number>;

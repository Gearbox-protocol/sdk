...
export declare type NewDonationEvent = TypedEvent<[BigNumber], NewDonationEventObject>;
export declare type NewDonationEventFilter = TypedEventFilter<NewDonationEvent>;

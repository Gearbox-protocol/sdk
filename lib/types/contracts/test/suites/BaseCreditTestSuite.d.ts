...
export interface BaseCreditTestSuiteInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "_getAccountAmount" | "_getCollateralTokens" | "acl" | "addMockPriceFeed" | "addressProvider" | "af" | "cr" | "failed" | "gp" | "lt" | "poolMock" | "priceOracle" | "testTokenSuite" | "underlying"): FunctionFragment;
...
export interface BaseCreditTestSuite extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseCreditTestSuiteInterface;

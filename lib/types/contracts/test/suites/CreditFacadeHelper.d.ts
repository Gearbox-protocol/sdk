...
export interface CreditFacadeHelperInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "cft" | "creditConfigurator" | "creditFacade" | "creditManager" | "failed" | "underlying"): FunctionFragment;
...
export interface CreditFacadeHelper extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CreditFacadeHelperInterface;

...
export interface CurveLPPriceFeedTestInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "test_OCLP_07_latestRoundData_reverts_for_out_of_bounds_prices", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_OCLP_07_latestRoundData_reverts_for_out_of_bounds_prices", data: BytesLike): Result;
    events: {
...
export interface CurveLPPriceFeedTest extends BaseContract {
    ...
    functions: {
        ...
        test_OCLP_07_latestRoundData_reverts_for_out_of_bounds_prices(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        test_OCLP_07_latestRoundData_reverts_for_out_of_bounds_prices(overrides?: CallOverrides): Promise<void>;
    };
    filters: {

...
export interface PriceOracleTestInterface extends utils.Interface {
    functions: {
        ...
        "test_PO_03_addPriceFeed_adds_pricefeed_and_emits_event()": FunctionFragment;
        "test_PO_04_getPrice_reverts_if_depends_on_address_but_zero_address_was_provided()": FunctionFragment;
        "test_PO_05_getPrice_reverts_if_not_passed_skipCheck_when_its_enabled()": FunctionFragment;
        "test_PO_06_getPrice_returns_correct_price(int256)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_PO_03_addPriceFeed_adds_pricefeed_and_emits_event", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "test_PO_05_getPrice_reverts_if_not_passed_skipCheck_when_its_enabled", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_PO_06_getPrice_returns_correct_price", values: [BigNumberish]): string;
...
export interface PriceOracleTest extends BaseContract {
    ...
    functions: {
        ...
        test_PO_03_addPriceFeed_adds_pricefeed_and_emits_event(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_PO_04_getPrice_reverts_if_depends_on_address_but_zero_address_was_provided(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_PO_05_getPrice_reverts_if_not_passed_skipCheck_when_its_enabled(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_PO_06_getPrice_returns_correct_price(price: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_PO_03_addPriceFeed_adds_pricefeed_and_emits_event(overrides?: CallOverrides): Promise<void>;
        test_PO_04_getPrice_reverts_if_depends_on_address_but_zero_address_was_provided(overrides?: CallOverrides): Promise<void>;
        test_PO_05_getPrice_reverts_if_not_passed_skipCheck_when_its_enabled(overrides?: CallOverrides): Promise<void>;
        test_PO_06_getPrice_returns_correct_price(price: BigNumberish, overrides?: CallOverrides): Promise<void>;

...
export interface LPPriceFeedTestInterface extends utils.Interface {
    functions: {
        ...
        "test_LPF_01_constructor_sets_correct_values()": FunctionFragment;
        "test_LPF_02_getRoundData_reverts()": FunctionFragment;
        "test_LPF_03_latestRoundData_works_correctly(uint256)": FunctionFragment;
        "test_LPF_04_setLimiter_reverts_for_non_configurator_or_with_zero_value()": FunctionFragment;
        "test_LPF_05_setLimiter_sets_bounds_correctly(uint256)": FunctionFragment;
    };
    ...
    encodeFunctionData(functionFragment: "test_LPF_01_constructor_sets_correct_values", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_LPF_02_getRoundData_reverts", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_LPF_03_latestRoundData_works_correctly", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_LPF_04_setLimiter_reverts_for_non_configurator_or_with_zero_value", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_LPF_05_setLimiter_sets_bounds_correctly", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "test_LPF_01_constructor_sets_correct_values", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_LPF_02_getRoundData_reverts", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_LPF_03_latestRoundData_works_correctly", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_LPF_04_setLimiter_reverts_for_non_configurator_or_with_zero_value", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_LPF_05_setLimiter_sets_bounds_correctly", data: BytesLike): Result;
    events: {
...
export interface LPPriceFeedTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LPPriceFeedTestInterface;
    ...
    functions: {
        ...
        test_LPF_01_constructor_sets_correct_values(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_LPF_02_getRoundData_reverts(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_LPF_03_latestRoundData_works_correctly(value: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_LPF_04_setLimiter_reverts_for_non_configurator_or_with_zero_value(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_LPF_05_setLimiter_sets_bounds_correctly(value: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        test_LPF_01_constructor_sets_correct_values(overrides?: CallOverrides): Promise<void>;
        test_LPF_02_getRoundData_reverts(overrides?: CallOverrides): Promise<void>;
        test_LPF_03_latestRoundData_works_correctly(value: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_LPF_04_setLimiter_reverts_for_non_configurator_or_with_zero_value(overrides?: CallOverrides): Promise<void>;
        test_LPF_05_setLimiter_sets_bounds_correctly(value: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {

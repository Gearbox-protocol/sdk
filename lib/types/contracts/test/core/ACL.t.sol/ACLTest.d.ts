...
export interface ACLTestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "failed" | "setUp" | "test_ACL_01_add_remove_reverts_on_non_owner" | "test_ACL_02_addPausableAdmin_adds_pool" | "test_ACL_03_removePausableAdmin_removes_admin" | "test_ACL_04_addUnpausableAdmin_adds_pool" | "test_ACL_05_removeUnpausableAdmin_removes_admin" | "test_ACL_06_isConfigurator_correct"): FunctionFragment;
    encodeFunctionData(functionFragment: "IS_TEST", values?: undefined): string;
    encodeFunctionData(functionFragment: "failed", values?: undefined): string;
    encodeFunctionData(functionFragment: "setUp", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACL_01_add_remove_reverts_on_non_owner", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACL_02_addPausableAdmin_adds_pool", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACL_03_removePausableAdmin_removes_admin", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACL_04_addUnpausableAdmin_adds_pool", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACL_05_removeUnpausableAdmin_removes_admin", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACL_06_isConfigurator_correct", values?: undefined): string;
    decodeFunctionResult(functionFragment: "IS_TEST", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "failed", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setUp", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACL_01_add_remove_reverts_on_non_owner", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACL_02_addPausableAdmin_adds_pool", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACL_03_removePausableAdmin_removes_admin", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACL_04_addUnpausableAdmin_adds_pool", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACL_05_removeUnpausableAdmin_removes_admin", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACL_06_isConfigurator_correct", data: BytesLike): Result;
    events: {
...
export interface ACLTest extends BaseContract {
    ...
    functions: {
        ...
        test_ACL_01_add_remove_reverts_on_non_owner(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACL_02_addPausableAdmin_adds_pool(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACL_03_removePausableAdmin_removes_admin(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACL_04_addUnpausableAdmin_adds_pool(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACL_05_removeUnpausableAdmin_removes_admin(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACL_06_isConfigurator_correct(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        test_ACL_01_add_remove_reverts_on_non_owner(overrides?: CallOverrides): Promise<void>;
        test_ACL_02_addPausableAdmin_adds_pool(overrides?: CallOverrides): Promise<void>;
        test_ACL_03_removePausableAdmin_removes_admin(overrides?: CallOverrides): Promise<void>;
        test_ACL_04_addUnpausableAdmin_adds_pool(overrides?: CallOverrides): Promise<void>;
        test_ACL_05_removeUnpausableAdmin_removes_admin(overrides?: CallOverrides): Promise<void>;
        test_ACL_06_isConfigurator_correct(overrides?: CallOverrides): Promise<void>;
    };
    filters: {

...
export interface ConvexV1AdapterBoosterTestInterface extends utils.Interface {
    functions: {
        ...
        "test_ACVX1_B_03_depositAll_without_staking_works_correctly()": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_ACVX1_B_03_depositAll_without_staking_works_correctly", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_ACVX1_B_03_depositAll_without_staking_works_correctly", data: BytesLike): Result;
...
export interface ConvexV1AdapterBoosterTest extends BaseContract {
    ...
    functions: {
        ...
        test_ACVX1_B_03_depositAll_without_staking_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_ACVX1_B_03_depositAll_without_staking_works_correctly(overrides?: CallOverrides): Promise<void>;

...
export interface CurveV1AdapterBaseMetaPoolTestInterface extends utils.Interface {
    functions: {
        ...
        "test_ACV1_M_01_constructor_sets_correct_values()": FunctionFragment;
        "test_ACV1_M_02_exchange_underlying_works_correctly()": FunctionFragment;
        "test_ACV1_M_03_exchange_all_underlying_works_correctly()": FunctionFragment;
        "test_ACV1_M_04_multicall_exchange_underlying_works_correctly()": FunctionFragment;
        "test_ACV1_M_05_multicall_exchange_all_underlying_works_correctly()": FunctionFragment;
        "underlying()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "adapter" | "cft" | "creditConfigurator" | "creditFacade" | "creditManager" | "curveV1Mock" | "failed" | "setUp" | "test_ACV1_M_01_constructor_sets_correct_values" | "test_ACV1_M_02_exchange_underlying_works_correctly" | "test_ACV1_M_03_exchange_all_underlying_works_correctly" | "test_ACV1_M_04_multicall_exchange_underlying_works_correctly" | "test_ACV1_M_05_multicall_exchange_all_underlying_works_correctly" | "underlying"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_ACV1_M_01_constructor_sets_correct_values", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACV1_M_02_exchange_underlying_works_correctly", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACV1_M_03_exchange_all_underlying_works_correctly", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACV1_M_04_multicall_exchange_underlying_works_correctly", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_ACV1_M_05_multicall_exchange_all_underlying_works_correctly", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_ACV1_M_01_constructor_sets_correct_values", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACV1_M_02_exchange_underlying_works_correctly", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACV1_M_03_exchange_all_underlying_works_correctly", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACV1_M_04_multicall_exchange_underlying_works_correctly", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_ACV1_M_05_multicall_exchange_all_underlying_works_correctly", data: BytesLike): Result;
...
export interface CurveV1AdapterBaseMetaPoolTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CurveV1AdapterBaseMetaPoolTestInterface;
    ...
    functions: {
        ...
        test_ACV1_M_01_constructor_sets_correct_values(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACV1_M_02_exchange_underlying_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACV1_M_03_exchange_all_underlying_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACV1_M_04_multicall_exchange_underlying_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_ACV1_M_05_multicall_exchange_all_underlying_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_ACV1_M_01_constructor_sets_correct_values(overrides?: CallOverrides): Promise<void>;
        test_ACV1_M_02_exchange_underlying_works_correctly(overrides?: CallOverrides): Promise<void>;
        test_ACV1_M_03_exchange_all_underlying_works_correctly(overrides?: CallOverrides): Promise<void>;
        test_ACV1_M_04_multicall_exchange_underlying_works_correctly(overrides?: CallOverrides): Promise<void>;
        test_ACV1_M_05_multicall_exchange_all_underlying_works_correctly(overrides?: CallOverrides): Promise<void>;
        underlying(overrides?: CallOverrides): Promise<string>;
    };
    filters: {

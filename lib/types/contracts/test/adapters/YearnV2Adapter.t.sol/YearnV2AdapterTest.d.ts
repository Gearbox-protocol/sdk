...
export interface YearnV2AdapterTestInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "test_AYV2_01_constructor_sets_correct_values", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_02_constructor_reverts_if_token_is_not_allowed", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_03_deposit_and_withdraw_if_uses_has_no_account", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_04_deposit_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_05_deposit_uint256_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_06_deposit_uint256_address_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_07_withdraw_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_08_withdraw_uint256_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_09_withdraw_uint256_address_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_10_withdraw_uint256_address_uint256_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_11_withdraw_correctly_passes_maxLoss", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_12_adapter_pricePerShare_consistent", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_13_adapter_name_consistent", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_14_adapter_symbol_consistent", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_15_adapter_decimals_consistent", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_16_adapter_allowance_consistent", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AYV2_17_adapter_balanceOf_totalSupply_consistent", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_AYV2_01_constructor_sets_correct_values", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_02_constructor_reverts_if_token_is_not_allowed", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_03_deposit_and_withdraw_if_uses_has_no_account", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_04_deposit_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_05_deposit_uint256_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_06_deposit_uint256_address_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_07_withdraw_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_08_withdraw_uint256_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_09_withdraw_uint256_address_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_10_withdraw_uint256_address_uint256_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_11_withdraw_correctly_passes_maxLoss", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_12_adapter_pricePerShare_consistent", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_13_adapter_name_consistent", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_14_adapter_symbol_consistent", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_15_adapter_decimals_consistent", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_16_adapter_allowance_consistent", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AYV2_17_adapter_balanceOf_totalSupply_consistent", data: BytesLike): Result;
...
export interface YearnV2AdapterTest extends BaseContract {
    ...
    functions: {
        ...
        test_AYV2_01_constructor_sets_correct_values(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_02_constructor_reverts_if_token_is_not_allowed(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_03_deposit_and_withdraw_if_uses_has_no_account(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_04_deposit_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_05_deposit_uint256_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_06_deposit_uint256_address_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_07_withdraw_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_08_withdraw_uint256_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_09_withdraw_uint256_address_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_10_withdraw_uint256_address_uint256_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_11_withdraw_correctly_passes_maxLoss(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_12_adapter_pricePerShare_consistent(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_13_adapter_name_consistent(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_14_adapter_symbol_consistent(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_15_adapter_decimals_consistent(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_16_adapter_allowance_consistent(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AYV2_17_adapter_balanceOf_totalSupply_consistent(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_AYV2_01_constructor_sets_correct_values(overrides?: CallOverrides): Promise<void>;
        test_AYV2_02_constructor_reverts_if_token_is_not_allowed(overrides?: CallOverrides): Promise<void>;
        test_AYV2_03_deposit_and_withdraw_if_uses_has_no_account(overrides?: CallOverrides): Promise<void>;
        test_AYV2_04_deposit_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AYV2_05_deposit_uint256_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AYV2_06_deposit_uint256_address_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AYV2_07_withdraw_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AYV2_08_withdraw_uint256_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AYV2_09_withdraw_uint256_address_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AYV2_10_withdraw_uint256_address_uint256_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AYV2_11_withdraw_correctly_passes_maxLoss(overrides?: CallOverrides): Promise<void>;
        test_AYV2_12_adapter_pricePerShare_consistent(overrides?: CallOverrides): Promise<void>;
        test_AYV2_13_adapter_name_consistent(overrides?: CallOverrides): Promise<void>;
        test_AYV2_14_adapter_symbol_consistent(overrides?: CallOverrides): Promise<void>;
        test_AYV2_15_adapter_decimals_consistent(overrides?: CallOverrides): Promise<void>;
        test_AYV2_16_adapter_allowance_consistent(overrides?: CallOverrides): Promise<void>;
        test_AYV2_17_adapter_balanceOf_totalSupply_consistent(overrides?: CallOverrides): Promise<void>;
        token(overrides?: CallOverrides): Promise<string>;
        underlying(overrides?: CallOverrides): Promise<string>;
        yearnV2Mock(overrides?: CallOverrides): Promise<string>;
        yvDAI(overrides?: CallOverrides): Promise<string>;

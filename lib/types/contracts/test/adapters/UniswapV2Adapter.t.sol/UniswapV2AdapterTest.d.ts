...
export interface UniswapV2AdapterTestInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "test_AUV2_01_swap_reverts_if_uses_has_no_account", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_02_swapTokensForExactTokens_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_03_swapExactTokensForTokens_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_04_swapAllTokensForTokens_works_for_user_as_expected", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_AUV2_05_adapter_quote_same_as_router", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_AUV2_06_adapter_getAmountOut_same_as_router", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_AUV2_07_adapter_getAmountIn_same_as_router", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_AUV2_08_adapter_getAmountsOut_same_as_router", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "test_AUV2_09_adapter_getAmountsIn_same_as_router", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "test_AUV2_01_swap_reverts_if_uses_has_no_account", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_02_swapTokensForExactTokens_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_03_swapExactTokensForTokens_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_04_swapAllTokensForTokens_works_for_user_as_expected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_05_adapter_quote_same_as_router", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_06_adapter_getAmountOut_same_as_router", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_07_adapter_getAmountIn_same_as_router", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_08_adapter_getAmountsOut_same_as_router", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_AUV2_09_adapter_getAmountsIn_same_as_router", data: BytesLike): Result;
...
export interface UniswapV2AdapterTest extends BaseContract {
    ...
    functions: {
        ...
        test_AUV2_01_swap_reverts_if_uses_has_no_account(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_02_swapTokensForExactTokens_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_03_swapExactTokensForTokens_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_04_swapAllTokensForTokens_works_for_user_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_05_adapter_quote_same_as_router(amountA: BigNumberish, reserveA: BigNumberish, reserveB: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_06_adapter_getAmountOut_same_as_router(amountIn: BigNumberish, reserveIn: BigNumberish, reserveOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_07_adapter_getAmountIn_same_as_router(amountOut: BigNumberish, reserveIn: BigNumberish, reserveOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_08_adapter_getAmountsOut_same_as_router(amountIn: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_AUV2_09_adapter_getAmountsIn_same_as_router(amountOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_AUV2_01_swap_reverts_if_uses_has_no_account(overrides?: CallOverrides): Promise<void>;
        test_AUV2_02_swapTokensForExactTokens_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AUV2_03_swapExactTokensForTokens_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AUV2_04_swapAllTokensForTokens_works_for_user_as_expected(overrides?: CallOverrides): Promise<void>;
        test_AUV2_05_adapter_quote_same_as_router(amountA: BigNumberish, reserveA: BigNumberish, reserveB: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_AUV2_06_adapter_getAmountOut_same_as_router(amountIn: BigNumberish, reserveIn: BigNumberish, reserveOut: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_AUV2_07_adapter_getAmountIn_same_as_router(amountOut: BigNumberish, reserveIn: BigNumberish, reserveOut: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_AUV2_08_adapter_getAmountsOut_same_as_router(amountIn: BigNumberish, overrides?: CallOverrides): Promise<void>;
        test_AUV2_09_adapter_getAmountsIn_same_as_router(amountOut: BigNumberish, overrides?: CallOverrides): Promise<void>;
        underlying(overrides?: CallOverrides): Promise<string>;
        uniswapMock(overrides?: CallOverrides): Promise<string>;
    };
    filters: {

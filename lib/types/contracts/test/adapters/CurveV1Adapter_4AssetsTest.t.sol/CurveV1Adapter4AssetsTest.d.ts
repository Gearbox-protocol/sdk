...
export interface CurveV1Adapter4AssetsTestInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "test_ACV1_4_04A_add_all_liquidity_one_coin_works_as_expected", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_ACV1_4_04A_add_all_liquidity_one_coin_works_as_expected", data: BytesLike): Result;
...
export interface CurveV1Adapter4AssetsTest extends BaseContract {
    ...
    functions: {
        ...
        test_ACV1_4_04A_add_all_liquidity_one_coin_works_as_expected(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_ACV1_4_04A_add_all_liquidity_one_coin_works_as_expected(overrides?: CallOverrides): Promise<void>;

...
export interface CreditManagerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_accountFactory" | "_acl" | "adapterToContract" | "addCollateral" | "addToken" | "approveCreditAccount" | "calcClosePayments" | "calcCreditAccountAccruedInterest" | "changeContractAllowance" | "checkAndEnableToken" | "closeCreditAccount" | "collateralTokens" | "collateralTokensByMask" | "collateralTokensCount" | "contractToAdapter" | "creditAccounts" | "creditConfigurator" | "creditFacade" | "cumulativeDropAtFastCheck" | "enabledTokensMap" | "executeOrder" | "fastCollateralCheck" | "fees" | "forbiddenTokenMask" | "fullCollateralCheck" | "getCreditAccountOrRevert" | "liquidationThresholds" | "manageDebt" | "openCreditAccount" | "pause" | "paused" | "pool" | "poolService" | "priceOracle" | "setConfigurator" | "setForbidMask" | "setLiquidationThreshold" | "setParams" | "tokenMasksMap" | "transferAccountOwnership" | "underlying" | "universalAdapter" | "unpause" | "upgradeContracts" | "version" | "wethAddress" | "wethGateway"): FunctionFragment;

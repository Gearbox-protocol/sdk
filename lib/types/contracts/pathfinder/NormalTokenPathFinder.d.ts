...
export interface NormalTokenPathFinderInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "findNormalTokenBestPath" | "findSwapQuote" | "getComplexPairSwap" | "getGasPriceTokenOutRAY" | "owner" | "priceOracle" | "renounceOwnership" | "swapPathFinder" | "transferOwnership" | "version" | "wethToken"): FunctionFragment;
    encodeFunctionData(functionFragment: "findNormalTokenBestPath", values: [ClosePathTaskStruct]): string;
    encodeFunctionData(functionFragment: "findSwapQuote", values: [ClosePathTaskStruct, BigNumberish, boolean]): string;
    encodeFunctionData(functionFragment: "getComplexPairSwap", values: [SwapTaskStruct, BigNumberish, BigNumberish, string[]]): string;
    ...
    encodeFunctionData(functionFragment: "swapPathFinder", values?: undefined): string;
    encodeFunctionData(functionFragment: "transferOwnership", values: [string]): string;
    encodeFunctionData(functionFragment: "version", values?: undefined): string;
    encodeFunctionData(functionFragment: "wethToken", values?: undefined): string;
    decodeFunctionResult(functionFragment: "findNormalTokenBestPath", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "findSwapQuote", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getComplexPairSwap", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "swapPathFinder", data: BytesLike): Result;
...
export interface NormalTokenPathFinder extends BaseContract {
    ...
    functions: {
        findNormalTokenBestPath(task: ClosePathTaskStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        findSwapQuote(task: ClosePathTaskStruct, tokenIndex: BigNumberish, isConnector: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getComplexPairSwap(swapTask: SwapTaskStruct, connectorIndex: BigNumberish, connectorCumulativeBalance: BigNumberish, adapters: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    wethToken(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        findNormalTokenBestPath(task: ClosePathTaskStruct, overrides?: CallOverrides): Promise<PathFinderResultStructOutput>;
        findSwapQuote(task: ClosePathTaskStruct, tokenIndex: BigNumberish, isConnector: boolean, overrides?: CallOverrides): Promise<[
            SwapQuoteStructOutput,
            string
        ] & {
            quote: SwapQuoteStructOutput;
            tokenOut: string;
        }>;
        getComplexPairSwap(swapTask: SwapTaskStruct, connectorIndex: BigNumberish, connectorCumulativeBalance: BigNumberish, adapters: string[], overrides?: CallOverrides): Promise<[
            SwapQuoteStructOutput,
            SwapQuoteStructOutput
        ] & {

...
export interface CurveLP3PriceFeedInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_acl" | "curvePool" | "decimals" | "decimalsDivider" | "delta" | "dependsOnAddress" | "description" | "getRoundData" | "latestRoundData" | "lowerBound" | "pause" | "paused" | "priceFeed1" | "priceFeed2" | "priceFeed3" | "priceFeedType" | "setLimiter" | "skipPriceCheck" | "unpause" | "upperBound" | "version"): FunctionFragment;

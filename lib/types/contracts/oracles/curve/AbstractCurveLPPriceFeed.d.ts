...
export interface AbstractCurveLPPriceFeedInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_acl" | "curvePool" | "decimals" | "decimalsDivider" | "delta" | "dependsOnAddress" | "description" | "getRoundData" | "latestRoundData" | "lowerBound" | "pause" | "paused" | "priceFeedType" | "setLimiter" | "skipPriceCheck" | "unpause" | "upperBound" | "version"): FunctionFragment;

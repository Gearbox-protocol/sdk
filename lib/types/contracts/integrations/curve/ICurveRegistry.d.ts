...
export interface ICurveRegistryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "get_lp_token" | "get_n_coins" | "get_pool_from_lp_token"): FunctionFragment;
...
export interface ICurveRegistry extends BaseContract {
    ...
    functions: {
        ...
        get_pool_from_lp_token(token: string, overrides?: CallOverrides): Promise<[string]>;
    };
    get_lp_token(pool: string, overrides?: CallOverrides): Promise<string>;
    get_n_coins(pool: string, overrides?: CallOverrides): Promise<BigNumber>;
    get_pool_from_lp_token(token: string, overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        get_n_coins(pool: string, overrides?: CallOverrides): Promise<BigNumber>;
        get_pool_from_lp_token(token: string, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        get_lp_token(pool: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        get_n_coins(pool: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        get_pool_from_lp_token(token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}

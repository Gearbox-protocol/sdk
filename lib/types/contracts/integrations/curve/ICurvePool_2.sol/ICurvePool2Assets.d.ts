...
export interface ICurvePool2AssetsInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "add_liquidity" | "balances(int128)" | "balances(uint256)" | "coins(int128)" | "coins(uint256)" | "exchange" | "exchange_underlying" | "get_dy" | "get_dy_underlying" | "get_virtual_price" | "remove_liquidity" | "remove_liquidity_imbalance" | "remove_liquidity_one_coin" | "token" | "underlying_coins(int128)" | "underlying_coins(uint256)"): FunctionFragment;

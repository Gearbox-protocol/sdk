...
export interface ICurvePool3Assets extends BaseContract {
    ...
    functions: {
        ...
        calc_token_amount(_amounts: [BigNumberish, BigNumberish, BigNumberish], _is_deposit: boolean, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        get_twap_balances(_first_balances: [BigNumberish, BigNumberish, BigNumberish], _last_balances: [BigNumberish, BigNumberish, BigNumberish], _time_elapsed: BigNumberish, overrides?: CallOverrides): Promise<[[BigNumber, BigNumber, BigNumber]]>;
    ...
    estimateGas: {
        ...
        get_twap_balances(_first_balances: [BigNumberish, BigNumberish, BigNumberish], _last_balances: [BigNumberish, BigNumberish, BigNumberish], _time_elapsed: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        get_virtual_price(overrides?: CallOverrides): Promise<BigNumber>;
        initial_A(overrides?: CallOverrides): Promise<BigNumber>;
        initial_A_time(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        calc_token_amount(_amounts: [BigNumberish, BigNumberish, BigNumberish], _is_deposit: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        get_twap_balances(_first_balances: [BigNumberish, BigNumberish, BigNumberish], _last_balances: [BigNumberish, BigNumberish, BigNumberish], _time_elapsed: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

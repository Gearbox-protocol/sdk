...
export interface WETHGatewayInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addLiquidityETH" | "removeLiquidityETH" | "unwrapWETH" | "version" | "wethAddress"): FunctionFragment;
...
export interface WETHGateway extends BaseContract {
    ...
    filters: {
        "WithdrawETH(address,address)"(pool?: string | null, to?: string | null): WithdrawETHEventFilter;
        WithdrawETH(pool?: string | null, to?: string | null): WithdrawETHEventFilter;
    };
    estimateGas: {
        addLiquidityETH(pool: string, onBehalfOf: string, referralCode: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;

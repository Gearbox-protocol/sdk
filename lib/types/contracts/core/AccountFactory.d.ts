...
export interface AccountFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_acl" | "_contractsRegister" | "addCreditAccount" | "cancelAllowance" | "countCreditAccounts" | "countCreditAccountsInStock" | "creditAccounts" | "getNext" | "head" | "isCreditAccount" | "masterCreditAccount" | "pause" | "paused" | "returnCreditAccount" | "tail" | "takeCreditAccount" | "takeOut" | "unpause" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "cancelAllowance", values: [string, string, string]): string;
    ...
    encodeFunctionData(functionFragment: "isCreditAccount", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "takeOut", values: [string, string, string]): string;
...
export interface AccountFactory extends BaseContract {
    ...
    functions: {
        ...
        cancelAllowance(account: string, token: string, targetContract: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        takeOut(prev: string, creditAccount: string, to: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        cancelAllowance(account: string, token: string, targetContract: string, overrides?: CallOverrides): Promise<void>;
        countCreditAccounts(overrides?: CallOverrides): Promise<BigNumber>;
        countCreditAccountsInStock(overrides?: CallOverrides): Promise<BigNumber>;
        creditAccounts(id: BigNumberish, overrides?: CallOverrides): Promise<string>;
        getNext(creditAccount: string, overrides?: CallOverrides): Promise<string>;
        ...
        takeOut(prev: string, creditAccount: string, to: string, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        isCreditAccount(addr: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isCreditAccount(addr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

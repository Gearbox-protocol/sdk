...
var ICreditManager__factory = /** @class */ (function () {
    function ICreditManager__factory() {
    }
    ICreditManager__factory.createInterface = function () {
        return new ethers_1.utils.Interface(_abi);
    };
    ICreditManager__factory.connect = function (address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    };
    ICreditManager__factory.abi = _abi;

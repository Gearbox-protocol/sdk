...
var PathAsset = /** @class */ (function () {
    ...
    PathAsset.prototype.getCurveExchangeData = function (adapterAddress, currentToken, currentBalance, nextToken, p) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    PathAsset.prototype.getExchangeData = function (swapAction, currentTokenAddress, currentToken, currentBalance, nextTokenAddress, nextToken, p) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.getCurveExchangeData(adapterAddress, currentToken, currentBalance, nextToken, p)];
                    case 6: return [2 /*return*/, _b.sent()];
                    case 7: throw Error("TradeType not supported. ".concat(actionType));
                }
            });
        });
    };

...
var ConnectorPathAsset = /** @class */ (function (_super) {
    ...
    ConnectorPathAsset.prototype.getBestPath = function (currentToken, p) {
        return __awaiter(this, void 0, void 0, function () {
            var currentBalance, currentTokenAddress, currentTokenData, nextToken, nextTokenAddress, exchangeData, _i, _a, swapAction, tmpExchangeData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        swapAction = _a[_i];
                        return [4 /*yield*/, this.getExchangeData(swapAction, currentTokenAddress, currentToken, currentBalance, nextTokenAddress, nextToken, p)];
                    case 2:
                        tmpExchangeData = _b.sent();
    ...
    ConnectorPathAsset.prototype.getMaxPoolAmount = function (currentToken, currentBalance, p) {
        return __awaiter(this, void 0, void 0, function () {
            var currentTokenAddress, currentTokenData, nextToken, nextTokenAddress, maxAmountOut, _i, _a, swapAction, exchangeData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        currentTokenAddress = token_1.tokenDataByNetwork[p.networkType][currentToken];

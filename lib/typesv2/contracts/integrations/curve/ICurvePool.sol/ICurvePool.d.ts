...
export interface ICurvePoolInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "balances" | "coins" | "exchange" | "exchange_underlying" | "get_dy" | "get_dy_underlying" | "get_virtual_price" | "remove_liquidity_one_coin" | "token" | "underlying_coins"): FunctionFragment;

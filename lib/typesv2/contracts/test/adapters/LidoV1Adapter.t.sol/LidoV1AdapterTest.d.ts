...
export interface LidoV1AdapterTestInterface extends utils.Interface {
    functions: {
        ...
        "test_LDOV1_02_submit_works_correctly()": FunctionFragment;
        "test_LDOV1_03_multicall_submit_works_correctly()": FunctionFragment;
        "underlying()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "cft" | "creditConfigurator" | "creditFacade" | "creditManager" | "failed" | "lidoV1Adapter" | "lidoV1Gateway" | "lidoV1Mock" | "setUp" | "test_LDOV1_01_constructor_sets_correct_params" | "test_LDOV1_02_submit_works_correctly" | "test_LDOV1_03_multicall_submit_works_correctly" | "underlying"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_LDOV1_02_submit_works_correctly", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_LDOV1_03_multicall_submit_works_correctly", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_LDOV1_02_submit_works_correctly", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_LDOV1_03_multicall_submit_works_correctly", data: BytesLike): Result;
...
export interface LidoV1AdapterTest extends BaseContract {
    ...
    functions: {
        ...
        test_LDOV1_02_submit_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        test_LDOV1_03_multicall_submit_works_correctly(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_LDOV1_02_submit_works_correctly(overrides?: CallOverrides): Promise<void>;
        test_LDOV1_03_multicall_submit_works_correctly(overrides?: CallOverrides): Promise<void>;
        underlying(overrides?: CallOverrides): Promise<string>;
    };
    filters: {

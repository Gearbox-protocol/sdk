...
export interface CreditFacadeTestSuiteInterface extends utils.Interface {
    functions: {
        ...
        "testFacadeWithDegenNFT(bool)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "maxBorrowedAmount", values?: undefined): string;
    encodeFunctionData(functionFragment: "minBorrowedAmount", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "testFacadeWithDegenNFT", values: [boolean]): string;
    ...
    decodeFunctionResult(functionFragment: "maxBorrowedAmount", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "minBorrowedAmount", data: BytesLike): Result;
...
export interface CreditFacadeTestSuite extends BaseContract {
    ...
    functions: {
        ...
        testFacadeWithDegenNFT(whitelisted: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        poolMock(overrides?: CallOverrides): Promise<string>;
        priceOracle(overrides?: CallOverrides): Promise<string>;
        testFacadeWithDegenNFT(whitelisted: boolean, overrides?: CallOverrides): Promise<void>;
        testTokenSuite(overrides?: CallOverrides): Promise<string>;
        underlying(overrides?: CallOverrides): Promise<string>;
    };
    filters: {

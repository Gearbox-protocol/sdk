...
export interface ICurveV1AdapterGaugeInterface extends utils.Interface {
    functions: {
...
export interface ICurveV1AdapterGauge extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ICurveV1AdapterGaugeInterface;

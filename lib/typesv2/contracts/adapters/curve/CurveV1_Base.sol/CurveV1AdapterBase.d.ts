...
export interface CurveV1AdapterBase extends BaseContract {
    ...
    functions: {
        ...
        add_all_liquidity_one_coin(arg0: BigNumberish, arg1: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        _gearboxAdapterType(overrides?: CallOverrides): Promise<number>;
        _gearboxAdapterVersion(overrides?: CallOverrides): Promise<number>;
        add_all_liquidity_one_coin(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<void>;
        balances(i: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        coins(i: BigNumberish, overrides?: CallOverrides): Promise<string>;
        creditFacade(overrides?: CallOverrides): Promise<string>;
        creditManager(overrides?: CallOverrides): Promise<string>;

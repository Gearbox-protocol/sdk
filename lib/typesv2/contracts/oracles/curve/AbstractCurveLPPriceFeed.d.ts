...
export interface AbstractCurveLPPriceFeedInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "curvePool" | "decimals" | "decimalsDivider" | "delta" | "dependsOnAddress" | "description" | "getRoundData" | "latestRoundData" | "lowerBound" | "pause" | "paused" | "priceFeedType" | "setLimiter" | "skipPriceCheck" | "unpause" | "upperBound" | "version"): FunctionFragment;

...
exports.tokenDataByAddress = (0, mappers_1.objectEntries)(exports.tokenDataByNetwork).reduce(function (acc, _a) {
    var _ = _a[0], tokens = _a[1];
    return __assign(__assign({}, acc), (0, mappers_1.keyToLowercase)((0, mappers_1.swapKeyValue)(tokens)));
}, {});

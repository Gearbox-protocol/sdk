...
function sortBalances(balances, prices, tokens) {
    return Object.entries(balances).sort(function (_a, _b) {
        ...
        var price2 = prices[addr1Lc] || 1;
        var assetValue1 = (0, price_1.priceCalc)(price1, amount1, tokens[addr1Lc]);
        var assetValue2 = (0, price_1.priceCalc)(price2, amount2, tokens[addr1Lc]);

...
var CreditManagerData = /** @class */ (function () {
    function CreditManagerData(_a) {
        var addr = _a.addr, _b = _a.underlyingToken, underlyingToken = _b === void 0 ? "" : _b, _c = _a.isWETH, isWETH = _c === void 0 ? false : _c, _d = _a.canBorrow, canBorrow = _d === void 0 ? false : _d, _e = _a.borrowRate, borrowRate = _e === void 0 ? 0 : _e, _f = _a.minAmount, minAmount = _f === void 0 ? 0 : _f, _g = _a.maxAmount, maxAmount = _g === void 0 ? 0 : _g, _h = _a.maxLeverageFactor, maxLeverageFactor = _h === void 0 ? 0 : _h, _j = _a.availableLiquidity, availableLiquidity = _j === void 0 ? 0 : _j, _k = _a.allowedTokens, allowedTokens = _k === void 0 ? [] : _k, _l = _a.adapters, adapters = _l === void 0 ? [] : _l, _m = _a.liquidationThresholds, liquidationThresholds = _m === void 0 ? [] : _m, _o = _a.version, version = _o === void 0 ? 1 : _o, _p = _a.creditFacade, creditFacade = _p === void 0 ? "" : _p, _q = _a.isDegenMode, isDegenMode = _q === void 0 ? false : _q, _r = _a.degenNFT, degenNFT = _r === void 0 ? "" : _r, _s = _a.isIncreaseDebtForbidden, isIncreaseDebtForbidden = _s === void 0 ? false : _s, _t = _a.forbiddenTokenMask, forbiddenTokenMask = _t === void 0 ? 0 : _t;
        this.id = addr;
        this.address = addr;
        ...
        this.liquidationThresholds = liquidationThresholds.map(function (threshold) { return threshold; });

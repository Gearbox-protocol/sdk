...
exports.priceFeedsByNetwork = {
    ...
    yvDAI: {
        priceFeedETH: {
            ...
            token: "DAI",
            lowerBound: constants_1.WAD,
            upperBound: constants_1.WAD.mul(10)
        },
        priceFeedUSD: {
            type: oracles_1.OracleType.YEARN_TOKEN_ORACLE,
            token: "DAI",
    ...
    yvUSDC: {
        priceFeedETH: {
            ...
            upperBound: ethers_1.BigNumber.from(100000000)
        },
        priceFeedUSD: {
            type: oracles_1.OracleType.YEARN_TOKEN_ORACLE,
            token: "USDC",
    ...
    yvWBTC: {
        priceFeedUSD: {
            type: oracles_1.OracleType.YEARN_TOKEN_ORACLE,
            token: "WBTC",
            lowerBound: ethers_1.BigNumber.from("100000000"),
            upperBound: ethers_1.BigNumber.from("10000000000")
        }
    },
    // CURVE LP TOKENS
    "3Crv": {
    ...
    yvCurve_stETH: {
        priceFeedUSD: {
            ...
            curveSymbol: "steCRV",
            lowerBound: constants_1.WAD,
            upperBound: constants_1.WAD.mul(100)
        }
    },
    yvCurve_FRAX: {
        priceFeedUSD: {

 ...
 **/
export type MalformedBracketKind =
  | "nested"
  | "unmatchedStore"
  | "unmatchedCompare";
 ...
 **/
export interface MalformedBracketError extends IGearboxError {
 ...
 **/
export interface AdapterCallOutsideBracketError extends IGearboxError {
 ...
 * does not know).
 **/
export interface NonAdapterCallInBracketError extends IGearboxError {
 ...
 * calldata).
 **/
export interface UnpreviewableAdapterCallError extends IGearboxError {
 ...
 **/
export interface UnsupportedOutOfBracketCallError extends IGearboxError {
 ...
 **/
export interface InvalidTransactionValueError extends IGearboxError {
 ...
 **/
export type MalformedPreviewError =
 ...
 **/
export type OperationPreviewError =

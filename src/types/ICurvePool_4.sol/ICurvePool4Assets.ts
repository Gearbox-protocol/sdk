...
export interface ICurvePool4AssetsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "A"
      | "A_precise"
...
export interface ICurvePool4Assets extends BaseContract {
  connect(runner?: ContractRunner | null): ICurvePool4Assets;
  ...
  get_balances: TypedContractMethod<
    [],
  ...
  get_previous_balances: TypedContractMethod<
    [],
    [[bigint, bigint, bigint, bigint]],
    "view"
  >;

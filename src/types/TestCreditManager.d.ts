...
interface TestCreditManagerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "provideCreditAccountAllowance(address,address)": FunctionFragment;
...
export class TestCreditManager extends Contract {
  ...
  interface: TestCreditManagerInterface;
  ...
  functions: {
    ...
    "provideCreditAccountAllowance(address,address)"(
      toContract: string,
      token: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

...
interface TraderAccountFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class TraderAccountFactory extends Contract {
  ...
  interface: TraderAccountFactoryInterface;

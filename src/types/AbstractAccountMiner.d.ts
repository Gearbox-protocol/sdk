...
interface AbstractAccountMinerInterface extends ethers.utils.Interface {
  functions: {
...
export class AbstractAccountMiner extends BaseContract {
  ...
  interface: AbstractAccountMinerInterface;

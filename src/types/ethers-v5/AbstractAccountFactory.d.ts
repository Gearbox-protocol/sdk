...
interface AbstractAccountFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class AbstractAccountFactory extends Contract {
  ...
  interface: AbstractAccountFactoryInterface;

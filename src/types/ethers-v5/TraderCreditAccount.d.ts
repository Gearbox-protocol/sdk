...
interface TraderCreditAccountInterface extends ethers.utils.Interface {
  functions: {
    "approveToken(address,address)": FunctionFragment;
    "borrowedAmount()": FunctionFragment;
    "creditManager()": FunctionFragment;
    "cumulativeIndexAtOpen()": FunctionFragment;
    "curveExchange(address,int128,int128,uint256,uint256)": FunctionFragment;
    ...
    "swapExactTokensForTokens(address,uint256,uint256,address[],uint256)": FunctionFragment;
    "swapTokensForExactTokens(address,uint256,uint256,address[],uint256)": FunctionFragment;
...
export class TraderCreditAccount extends Contract {
  ...
  interface: TraderCreditAccountInterface;
  ...
  functions: {
    ...
    "curveExchange(address,int128,int128,uint256,uint256)"(
      curvePoolAddress: string,
      i: BigNumberish,
      j: BigNumberish,
      dx: BigNumberish,
    ...
    "swapExactTokensForTokens(address,uint256,uint256,address[],uint256)"(
      swapProtocol: string,
      amountIn: BigNumberish,
      amountOutMin: BigNumberish,
      path: string[],
    ...
    "swapTokensForExactTokens(address,uint256,uint256,address[],uint256)"(
      swapProtocol: string,
      amountOut: BigNumberish,
      amountInMax: BigNumberish,
      path: string[],

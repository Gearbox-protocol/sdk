...
interface TraderCreditManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class TraderCreditManager extends Contract {
  ...
  interface: TraderCreditManagerInterface;

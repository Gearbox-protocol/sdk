...
interface StableCreditManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class StableCreditManager extends Contract {
  ...
  interface: StableCreditManagerInterface;

...
export interface ICurveV1_2AssetsAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_gearboxAdapterType"
...
export interface ICurveV1_2AssetsAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): ICurveV1_2AssetsAdapter;
  ...
  add_liquidity: TypedContractMethod<
    [amounts: [BigNumberish, BigNumberish], arg1: BigNumberish],
    [[bigint, bigint] & { tokensToEnable: bigint; tokensToDisable: bigint }],
    "nonpayable"
  >;

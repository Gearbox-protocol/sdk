...
export interface ICurvePool3AssetsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "A"
      | "A_precise"
...
export interface ICurvePool3Assets extends BaseContract {
  connect(runner?: ContractRunner | null): ICurvePool3Assets;
  ...
  get_balances: TypedContractMethod<[], [[bigint, bigint, bigint]], "view">;
  ...
  get_twap_balances: TypedContractMethod<
    [
      _first_balances: [BigNumberish, BigNumberish, BigNumberish],
      _last_balances: [BigNumberish, BigNumberish, BigNumberish],

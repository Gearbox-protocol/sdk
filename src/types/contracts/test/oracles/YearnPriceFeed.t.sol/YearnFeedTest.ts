...
export interface YearnFeedTestInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "pf"
      | "setUp"
      | "test_YPF_01_constructor_sets_correct_values"
      | "test_YPF_02_constructor_reverts_for_zero_addresses"
      | "test_YPF_04_latestRoundData_works_correctly"
      | "test_YPF_05_latestRoundData_reverts_for_out_of_bounds_prices"
      | "underlyingPf"
      | "yearnMock"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_YPF_01_constructor_sets_correct_values",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_YPF_02_constructor_reverts_for_zero_addresses",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_YPF_05_latestRoundData_reverts_for_out_of_bounds_prices",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "underlyingPf",
    values?: undefined
  ): string;

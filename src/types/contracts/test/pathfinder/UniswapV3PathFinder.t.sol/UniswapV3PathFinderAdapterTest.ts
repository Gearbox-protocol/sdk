...
export interface UniswapV3PathFinderAdapterTestInterface
  ...
  encodeFunctionData(
    functionFragment: "test_PUV3_02_getBestPairSwap_returns_correct_swapQuote",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_PUV3_03_getBestPairSwap_returns_empty_swapQuote_when_pair_not_found",
    values?: undefined
  ): string;
  encodeFunctionData(

...
export interface YearnPathFinderTestInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "failed"
      | "setUp"
      | "test_YPF_01_filterYearnAdapters_finds_yearn_adapters_only"
      | "test_YPF_02_estimateWithdraw_coverts_withfdraw_correctly"
      | "test_YPF_03_withdrawAll_works_correctly"
      | "tokenMasksMap"
      | "underlying"
      | "uniV2adapter"
      | "uniV2mock"
  ...
  encodeFunctionData(
    functionFragment: "test_YPF_01_filterYearnAdapters_finds_yearn_adapters_only",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_YPF_02_estimateWithdraw_coverts_withfdraw_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_YPF_03_withdrawAll_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(

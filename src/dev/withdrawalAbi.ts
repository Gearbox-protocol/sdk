// ABIs extracted from @gearbox-protocol/integrations-v3 forge artifacts (out/)
// Used by dev helpers for delayed withdrawals, see ./withdrawalUtils.ts

export const midasGatewayAbi = [
  {
    type: "constructor",
    inputs: [
      {
        name: "_midasIssuanceVault",
        type: "address",
        internalType: "address",
      },
      {
        name: "_midasRedemptionVault",
        type: "address",
        internalType: "address",
      },
      {
  ...
  {
    type: "function",
    name: "expectedRedemptionDuration",
    inputs: [],
    outputs: [
      {
        name: "",
...
export const midasRedeemerAbi = [
  ...
  {
    type: "error",
    name: "CallerNotGatewayException",
    inputs: [],
  },
  {
    type: "error",
...
export const midasRedemptionVaultPhantomTokenAbi = [
  {
    type: "constructor",
    inputs: [
      {
...
export const iMidasDataFeedAbi = [
  {
    type: "function",
...
export const securitizeRedemptionGatewayAbi = [
  {
    type: "constructor",
    inputs: [
      {
      ...
      {
        name: "_redemptionAccount",
        type: "address",
        internalType: "address",
      },
      {
        name: "_securitizeWhitelister",
        type: "address",
        internalType: "address",
      },
      {
...
export const securitizeRedemptionPhantomTokenAbi = [
  {
    type: "constructor",
    inputs: [
      {
...
export const securitizeRedeemerAbi = [
  {
    type: "constructor",
    inputs: [
      {
  ...
  {
    type: "function",
    name: "dsTokenDecimalsMultiplier",
    inputs: [],
    outputs: [
      {
        name: "",
  ...
  {
    type: "function",
    name: "getCurrentRedemptionValue",
    inputs: [],
    outputs: [
      {
        name: "",
  ...
  {
    type: "function",
    name: "stableCoinDecimalsMultiplier",
    inputs: [],
    outputs: [
      {
        name: "",

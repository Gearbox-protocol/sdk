...
import type { NetworkType, OnchainSDK } from "../onchain/index.js";
import { MultichainSDK, SdkNotAttachedError } from "../onchain/index.js";
...
describe("GearboxSDK loading", () => {
  ...
  it("a prepare call attaches on first use and revalidates only its chain", async () => {
    ...
    const result = await sdk.opportunities.prepare.addCollateral(

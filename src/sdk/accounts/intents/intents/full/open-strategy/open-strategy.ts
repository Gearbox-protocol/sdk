...
import { assertDebtInRange, debtForLeverage } from "../common.js";
...
export async function previewOpenStrategy(
  ...
  // Synthetic slice so the shared debt check and the router helper can be reused
  // even though no account exists yet.
  ...
  assertDebtInRange(debt, account, sdk);

...
// tests ported from https://github.com/pyth-network/pyth-crosschain/blob/66004244326eaafa31d11fe456bf976295418ae2/price_service/sdk/js/src/__tests__/AccumulatorUpdateData.test.ts
describe("Test parse accumulator update", () => {
  test("Happy path", async () => {
    const { vaa: _, updates } = parseAccumulatorUpdateData(

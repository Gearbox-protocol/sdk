...
export type DegenStruct = { degenAddress: string; mintBalance: BigNumberish };

export type DegenStructOutput = [string, number] & {
  degenAddress: string;
  mintBalance: number;
};
...
export interface DegenNFTInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "limitedEdition",
    values?: undefined
  ): string;

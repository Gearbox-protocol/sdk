...
export interface CreditManagerTestInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_CM_41_fullCollateralCheck_sets_fastCheckCounter_to_1"
  ...
  encodeFunctionData(
    functionFragment: "test_CM_33_fastCollateralCheck_is_skipper_if_ltOut_less_ltIn",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_CM_34_fastCollateralCheck_is_skipper_fastCheckCounter_creditAccount_gt_hfCheckInterval",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_CM_35_fastCollateralCheck_disable_tokens_with_zero_balance",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_CM_36_fastCollateralCheck_increase_fastCheckCounter_for_fast_check",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_CM_37_fastCollateralCheck_enables_fullCollateralCheck_if_chi_equition_is_not_true",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_CM_41_fullCollateralCheck_sets_fastCheckCounter_to_1",
    values?: undefined
  ): string;
  encodeFunctionData(

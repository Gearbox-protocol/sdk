...
export interface CurveV1Adapter2AssetsTestInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "failed"
      | "setUp"
      | "test_ACV1_2_01_constructor_sets_correct_values"
      | "test_ACV1_2_02A_constructor_reverts_for_unknown_addresses"
      | "test_ACV1_2_02_constructor_reverts_for_zero_addresses"
      | "test_ACV1_2_03_liquidity_functions_revert_if_user_has_no_account"
      | "test_ACV1_2_04_add_liquidity_works_as_expected"
      ...
      | "test_ACV1_2_08_multicall_remove_liquidity_works_as_expected"
      | "test_ACV1_2_09_multicall_remove_liquidity_imbalance_works_as_expected"
      | "test_ACV1_2_10_get_token_reverts_for_incorrect_indices"
      | "underlying"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_ACV1_2_01_constructor_sets_correct_values",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_ACV1_2_02_constructor_reverts_for_zero_addresses",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_2_03_liquidity_functions_revert_if_user_has_no_account",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_2_04_add_liquidity_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_2_05_remove_liquidity_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_2_06_remove_liquidity_imbalance_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_2_07_multicall_add_liquidity_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_2_08_multicall_remove_liquidity_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_2_09_multicall_remove_liquidity_imbalance_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_2_10_get_token_reverts_for_incorrect_indices",
    values?: undefined
  ): string;
  encodeFunctionData(

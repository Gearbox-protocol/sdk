...
export interface CurveV1StEthAdapterTestInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_ACV1S_08_multicall_add_liquidity_works_correctly"
      | "test_ACV1S_09_multicall_remove_liquidity_works_correctly"
  ...
  encodeFunctionData(
    functionFragment: "test_ACV1S_08_multicall_add_liquidity_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1S_09_multicall_remove_liquidity_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1S_10_multicall_exchange_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1S_11_multicall_remove_liquidity_one_coin_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1S_12_multicall_remove_all_liquidity_one_coin_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1S_13_multicall_remove_liquidity_imbalance_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(

...
export interface CurveV1Adapter3AssetsTestInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_ACV1_3_04_add_liquidity_works_as_expected"
      | "test_ACV1_3_05_remove_liquidity_works_as_expected"
  ...
  encodeFunctionData(
    functionFragment: "test_ACV1_3_01_constructor_sets_correct_values",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_02A_constructor_reverts_for_unknown_addresses",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_02_constructor_reverts_for_zero_addresses",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_03_liquidity_functions_revert_if_user_has_no_account",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_04_add_liquidity_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_05_remove_liquidity_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_06_remove_liquidity_imbalance_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_07_multicall_add_liquidity_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_08_multicall_remove_liquidity_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_09_multicall_remove_liquidity_imbalance_works_as_expected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_ACV1_3_10_get_token_reverts_for_incorrect_indices",
    values?: undefined
  ): string;
  encodeFunctionData(

...
export interface LidoV1AdapterTestInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_LDOV1_02_submit_works_correctly"
      | "test_LDOV1_03_multicall_submit_works_correctly"
      | "underlying"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_LDOV1_02_submit_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_LDOV1_03_multicall_submit_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(

...
import { iCurvePoolAbi } from "../abi/targetContractAbi.js";
import type {
...
const protocolAbi = iCurvePoolAbi;
type protocolAbi = typeof protocolAbi;

export class CurveV1AdapterDeposit extends AbstractCurveAdapterContract<
  abi,
  protocolAbi
> {
  #token?: Address;

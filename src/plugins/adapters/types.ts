...
export type AdapterContractType =
  ...
  | "ADAPTER::MELLOW_DEPOSIT_QUEUE_QUEUE"
  | "ADAPTER::MELLOW_REDEEM_QUEUE_QUEUE"
  ...
  | "ADAPTER::SECURITIZE_SWAP"
  | "ADAPTER::STAKING_REWARDS"
  | "ADAPTER::TRADER_JOE_ROUTER"
...
export enum AdapterType {
  ...
  MELLOW_DEPOSIT_QUEUE = "MELLOW_DEPOSIT_QUEUE",

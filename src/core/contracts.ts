...
export const contractsByNetwork: Record<NetworkType,
    ...
    Mainnet: {
        ...
        CURVE_SUSD_DEPOSIT: "0x22eE18aca7F3Ee920D01F25dA85840D12d98E8Ca",
...
export const contractsByAddress = objectEntries(contractsByNetwork).reduce<Record<string, SupportedContract>>((sum, [_, contracts]) => {

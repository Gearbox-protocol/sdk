...
- [ ] VSR_101 — declass parse errors: errors.ts keeps interface+factory; parseOperationCalldata.ts and parsePoolOperationCalldata.ts throw factories; previewOperationErrors.test.ts opens the clean-surface spec (9 min)
